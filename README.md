...
> _(Replace the placeholders below with actual screenshots after running the app.)_

### Join Screen
```
+---------------------------------------+
|  ● LiveChat                           |
|  Real-time conversations, zero        |
|  friction.                            |
|                                       |
|  YOUR USERNAME                        |
|  [ e.g. Harry                      ]  |
...
- There is **no authentication** — any username can be entered freely.
- For production use, consider adding TLS (wss://) and a reverse proxy (nginx).
